...
})({"ltMpz":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9488d02f9bb0808f";
...
},{}],"5PbDP":[function(require,module,exports) {
"use strict";
...
fetch(`https://pokeapi.co/api/v2/pokemon/${pokemonID}`).then((response)=>response.json()
    ...
    if (pokemon) pokemon.append(pokemonDetails);
    const abilityList = document.createElement("ul");
    abilityList.classList.add("abilities");
    pokemonInfo.abilities.forEach((abilityObject)=>{
        fetch(abilityObject.ability.url).then((response)=>response.json()
        ).then((abilityInfo)=>{
    ...
    if (abilitiesContainer) abilitiesContainer.append(abilityList);
});

},{"./index":"fImJM"}],"fImJM":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
fetch(pokeAPIURL).then((response)=>response.json()
    ...
    `;
        const spinner = document.querySelector(".spinner");
        if (spinner) spinner.classList.add("hidden");
        if (pokemonList) pokemonList.append(pokemonOption);
    });
});
...
},{}]},["ltMpz","5PbDP"], "5PbDP", "parcelRequire80db")

//# sourceMappingURL=pokemon.9bb0808f.js.map
